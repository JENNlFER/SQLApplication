...
public class SQLPreferences
{
	...
	{
		if (execHighlightedBoolean)
		{
			execHighlightedBoolean = false;
		}
		else
		{
			execHighlightedBoolean = true;
		}
	}
	...
	{
		if (printStatusHighlightedBoolean)
		{
			printStatusHighlightedBoolean = false;
		}
		else
		{
			printStatusHighlightedBoolean = true;
		}
	}
	...
	{
		if (printErrorHighlightedBoolean)
		{
			printErrorHighlightedBoolean = false;
		}
		else
		{
			printErrorHighlightedBoolean = true;
		}
	}
	...
	{
		if (emptyLineButton.isSelected())
		{
			emptyLineButton.setSelected(false);
		}
		if (eachLineButton.isSelected())
		{
			eachLineButton.setSelected(false);
		}
